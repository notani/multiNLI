...
if os.path.isfile(test_matched):
    test_matched = "{}/multinli_1.0/multinli_1.0_dev_matched.jsonl".format(args.datapath) #"{}/multinli_1.0/multinli_1.0_test_matched.jsonl".format(args.datapath)
    test_mismatched = "{}/multinli_1.0/multinli_1.0_dev_mismatched.jsonl".format(args.datapath) #"{}/multinli_1.0/multinli_1.0_test_mismatched.jsonl".format(args.datapath)
...
def load_parameters():
    if args.embpath is None:
        args.embpath = "{}/glove.840B.300d.txt".format(args.datapath)
    FIXED_PARAMETERS = {
        ...
        "embedding_data_path": args.embpath,
